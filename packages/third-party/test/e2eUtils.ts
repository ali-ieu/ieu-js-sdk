...
// https://stackoverflow.com/questions/62395711/puppeteer-identify-when-recaptcha-challenge-becomes-active-visible
...
export async function expectByPolling(poll: () => Promise<any>, expected: string): Promise<void> {
